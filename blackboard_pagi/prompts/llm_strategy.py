...
from blackboard_pagi.prompts.dataclasses_schema import DataclassesSchema
from blackboard_pagi.prompts.llm_implement import LLMCall, unwrap_function
...
def llm_strategy_dataclass(
    dataclass_type: type[T], llm: langchain.llms.LLM, parent_dataclasses_schema: DataclassesSchema | None = None
) -> type[T]:
